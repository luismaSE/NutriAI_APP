...
class Meal:
    def __init__(self, ingredients: list, cautions: list, diet_labels: list, health_labels: list, rda: dict | None = None, id: str | None = None, created_at: str | None = None, image_base64: str | None = None) -> None:
        ...
        self.created_at = created_at if created_at else datetime.utcnow().isoformat()  # Fecha de creación por defecto
        self.image_base64 = image_base64  # Imagen en base64, opcional

    def __repr__(self):
        return f'<Meal {self.id} created at {self.created_at}>'
    ...
    def to_json(self):
        return {
            ...
            'created_at': self.created_at,  # Nuevo campo
            'image_base64': self.image_base64  # Nuevo campo
        }
    ...
    def from_json(cls, data: dict):
        ...
        return cls(
            ...
            data.get('rda'),
            data.get('id'),
            data.get('created_at'),  # Recuperar created_at
            data.get('image_base64')  # Recuperar image_base64
        )
